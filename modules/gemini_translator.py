...
1. Описание RU: 1-2 sentences in Russian. Must be SPECIFIC to this exact test/procedure.
   - What does it measure/show? What clinical purpose?
   - BAD: "Данный анализ помогает определить показатели организма..."
   - GOOD: "Анализ позволяет определить уровень тиреотропного гормона, который регулирует функцию щитовидной железы и помогает выявить гипо- или гипертиреоз."
